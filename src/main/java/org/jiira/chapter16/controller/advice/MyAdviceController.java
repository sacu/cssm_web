package org.jiira.chapter16.controller.advice;
...
public class MyAdviceController {
	 ...
	 * @return map
	 * 
	 * http://127.0.0.1:8080/SSM_WEB/advice/test.do?date=2017-06-23&amount=123,456,78
	 */
	@RequestMapping("/test")
	@ResponseBody
	public Map<String, Object> testAdvice(Date date, @NumberFormat(pattern = "##,###.00") BigDecimal amount, Model model) {
		...
		//projectName是在CommonControllerAdvice中设置的
